...
public class Matrix4f {
	...
	public Vector3f Transform(Vector3f r) {
		return new Vector3f(m[0][0] * r.GetX() + m[0][1] * r.GetY() + m[0][2] * r.GetZ() + m[0][3], m[1][0] * r.GetX() + m[1][1] * r.GetY() + m[1][2] * r.GetZ() + m[1][3], m[2][0] * r.GetX()
				+ m[2][1] * r.GetY() + m[2][2] * r.GetZ() + m[2][3]);
	}
