...
public class Input {
	...
	private static boolean m_mouseEnabled = true;
	private static Vector2f m_dynamicPos = new Vector2f(0, 0);
	...
	public static void Update() {
		...
		m_dynamicPos = new Vector2f(Mouse.getDX(), Mouse.getDY());
	}
	...
	/**
	 * Returns the change in mouse position, hence 'dynamic'
	 * @return
	 */
	public static Vector2f GetMouseDynamicPosition() {
		return m_dynamicPos;
	}
	
	/**
	 * To be called after the window is updated.
	 * Determines if the mouse should be centered.
	 */
	public static void DetermineMouse() {
		if (!m_mouseEnabled) {
